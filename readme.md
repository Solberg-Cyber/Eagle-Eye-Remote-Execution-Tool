...
** Purpose of this script: **
	...
	This is a remote execution script built and designed with the purpose of addressing the various stages of the incident response 
	lifecycle. However, this script could easily be adapted to many tasks by adding/removing commands to be executed (look for 
	the invoke-command loop) in the script. This script could be especially useful for things like system administration, or in any
	situation where you would wish to run local commands against all Windows computers on a subnet at once, such as to make registry 
	changes or to turn off a vulnerable and unecessary service.
...
** Design **
	...
	as a timestamped report, providing a structured snapshot of system information and persistence artifacts for review and analysis.
...
** Versions **
	...
	In other words, the primary difference between the two scripts is their speed. The powershell 7 version is much faster against large
	networks.
